...
class Walker2dFeasibilityEnv(Walker2dEnv):
    def __init__(self,
                 xml_file='walker2d.xml',
                 forward_reward_weight=1.0,
                 ctrl_cost_weight=1e-3,
        ...
        super(Walker2dFeasibilityEnv, self).__init__(xml_file, forward_reward_weight, ctrl_cost_weight, healthy_reward,
                 terminate_when_unhealthy, healthy_z_range, healthy_angle_range,
                 reset_noise_scale, exclude_current_positions_from_observation)
